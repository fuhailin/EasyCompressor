...
copy_file(
    name = "copy_config",
    src = select({
        ":android": "@rules_compressor//lzma:config.lzma-linux.h",
        ":linux": "@rules_compressor//lzma:config.lzma-linux.h",
        ":osx_arm64": "@rules_compressor//lzma:config.lzma-osx-arm64.h",
        ":osx_x86_64": "@rules_compressor//lzma:config.lzma-osx-x86_64.h",
        ":windows": "@rules_compressor//lzma:config.lzma-windows.h",
    }),
